 ...
 */
suspend fun menu(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
...
suspend fun menuTurnos(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
...
suspend fun menuPedidos(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
...
suspend fun menuTareas(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
    while (userInput < 1 || userInput > 6) {
        println("""
        Select something to do: 
...
suspend fun menuMaquinas(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
    while (userInput < 1 || userInput > 6) {
        println("""
        Select something to do: 
...
suspend fun menuProductos(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
    while (userInput < 1 || userInput > 6) {
        println("""
        Select something to do: 
        ...
        1 -> {
            ...
            while (i < 1 || i > 3) {
                println("""
                        ...
                        1. no
                        2. Yes (available only)
                        3. Yes (unavailable only)
                    """.trimIndent())
                i = readln().toIntOrNull() ?: 0
            }
            val request = when (i) {
                1 -> controller.findAllProductos()
                2 -> controller.findAllProductosDisponibles(true)
                3 -> controller.findAllProductosDisponibles(false)
                else -> return false
            }
            println(request)
            return false
...
suspend fun menuUsers(json: ObjectWriter, token: String, controller: Controller): Boolean {
    var userInput = 0
    while (userInput < 1 || userInput > 6) {
        println("""
        Select something to do: 
