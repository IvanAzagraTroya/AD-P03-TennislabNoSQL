 ...
 */
sealed class TurnoResponse<Turno>
 ...
 */
class TurnoResponseSuccess<T: Any>(val code: Int, val data: T) : TurnoResponse<T>()
 ...
 */
class TurnoResponseError(val code: Int, val message: String?) : TurnoResponse<Nothing>()
